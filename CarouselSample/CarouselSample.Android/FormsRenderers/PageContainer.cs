...
{
    internal class MyPageContainer : ViewGroup
    {
        public MyPageContainer(Context context, IVisualElementRenderer child, bool inFragment = false) : base(context)
        {
            AddView(child.View);
            Child = child;
        ...
        protected MyPageContainer(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }
