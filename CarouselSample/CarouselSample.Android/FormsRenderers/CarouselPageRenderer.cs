...
using Android.Views;
using CarouselSample.Droid.Class;
using CarouselSample.Droid.FormsRenderers;
using Xamarin.Forms;
...
namespace CarouselSample.Droid.Forms_Renderers
{
    public class MyCarouselPageRenderer : VisualElementRenderer<CarouselPage>
    {
        ...
        public MyCarouselPageRenderer(Context context) : base(context)
        {
            AutoPackage = false;
        }
        ...
        protected override void OnAttachedToWindow()
        {
            ...
            var adapter = new MyCarouselPageAdapter(_viewPager, Element, Context);
            _viewPager.Adapter = adapter;
            _viewPager.AddOnPageChangeListener(adapter);

            adapter.UpdateCurrentItem();

            if (Parent is MyPageContainer pageContainer && (pageContainer.IsInFragment
                || pageContainer.Visibility == ViewStates.Gone))
                return;
        ...
        protected override void OnLayout(bool changed, int l, int t, int r, int b)
        {
            ...
            if (_viewPager != null)
            {
                _viewPager.Measure(MyMeasureSpecFactory.MakeMeasureSpec(r - l, MeasureSpecMode.Exactly), MyMeasureSpecFactory.MakeMeasureSpec(b - t, MeasureSpecMode.Exactly));
